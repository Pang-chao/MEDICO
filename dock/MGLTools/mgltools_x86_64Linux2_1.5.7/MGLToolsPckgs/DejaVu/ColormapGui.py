...
#############################################################################
#
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/DejaVu/ColormapGui.py,v 1.84.8.1 2016/02/11 01:25:20 annao Exp $
#
# $Id: ColormapGui.py,v 1.84.8.1 2016/02/11 01:25:20 annao Exp $
#
...
from DejaVu.colorTool import RGBARamp, RedWhiteBlueRamp, RedWhiteRamp, \
     WhiteBlueRamp, TkColor
from DejaVu.Legend import drawLegendOnly
...
"""
    ...
    def __init__(self, cmap=None, master=None, continuous=0,  allowRename=True, modifyMinMax=False,
        ...
        # DejaVu viewer to which colorMapLegend is added 
        self.viewer = None 
