...
#########################################################################
#
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/DejaVu/VisionInterface/GeometryNodes.py,v 1.132.8.1 2016/02/11 01:25:21 annao Exp $
#
# $Id: GeometryNodes.py,v 1.132.8.1 2016/02/11 01:25:21 annao Exp $
#
...
"""
        from DejaVu.DataInput import readAnySTL
...
"""
    ...
    def readFileOBJ(self, filename):
        """from a filename, returns a list of geoms
"""
        from DejaVu.DataInput import readOBJ
...
"""
    ...
    def appendGeometry(self, name):
        self.removePreviousGeomWithSameName(name)
        #print "appendGeometry"
        from DejaVu.StickerImage import StickerImage
...
"""
    ...
    def __init__(self, name = "decimateGeom", **kw):
        ...
        from DejaVu.VisionInterface.DejaVuNodes import QSlimDecimate
