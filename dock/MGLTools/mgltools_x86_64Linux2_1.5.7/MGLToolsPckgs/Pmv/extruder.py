...
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/Pmv/extruder.py,v 1.40.2.1 2016/02/11 21:29:43 annao Exp $
#
# $Id: extruder.py,v 1.40.2.1 2016/02/11 21:29:43 annao Exp $
#

import numpy
import math
from Pmv import Ribbon
...
# Gotta move this class in DejaVu not dependent on MolKit any longer
class Sheet2D:
...
class ExtrudeObject:
	...
	#                                     <v[lp-lenarrow:] translated >
        ...
        # We apply the translation to the vertices that belongs to the arrow
        # and reorganize them in the array of points so the array contains
        # three blocs of vertices see the drawing above:
