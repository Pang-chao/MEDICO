# $Header: /mnt/raid/services/cvs/CADD/Raccoon/about.py,v 1.1 2012/07/18 22:36:26 sanner Exp $
# $Id: about.py,v 1.1 2012/07/18 22:36:26 sanner Exp $
import Tkinter, os
...
class About:
    ...
    def gui(self, master):
        ...
        basepath = os.path.join(os.path.split(__file__)[0], 'icons')
        ...
        #SPA = Image.open(os.path.join(basepath,'spawarIcon.png'))
        #self.SPA = ImageTk.PhotoImage(SPA, master=master)
        #self.SPATk = Tkinter.Label(logoFrame,image=self.SPA, bd=0)
        #self.SPATk.pack(side='left', padx=40, expand=True)
