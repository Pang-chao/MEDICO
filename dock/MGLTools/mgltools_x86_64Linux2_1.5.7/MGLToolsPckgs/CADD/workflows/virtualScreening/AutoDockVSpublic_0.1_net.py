...
#    Thursday 24 February 2011 02:17:00 
#    
...
#########################################################################
#
# $Header: /mnt/raid/services/cvs/CADD/workflows/virtualScreening/AutoDockVSpublic_0.1_net.py,v 1.1 2011/04/15 16:19:39 nadya Exp $
#
# $Id: AutoDockVSpublic_0.1_net.py,v 1.1 2011/04/15 16:19:39 nadya Exp $
#
...
try:
    ...
    masterNet.addNode(PublicServerLigandDB_37,697,24)
...
try:
    ...
    masterNet.addNode(FilterLigandsNode_38,697,141)
...
try:
    ...
    masterNet.addNode(PreserveCharges__39,963,18)
...
try:
    ...
    masterNet.addNode(DownloadSaveDir_40,149,560)
...
try:
    ...
    GetStructuresFromDir_41.inputPortByName['directory'].widget.set(r"AutoDockVSpublic_0.1_input", run=False)
...
try:
    ...
    masterNet.addNode(InputValidation_42,132,317)
    apply(InputValidation_42.addInputPort, (), {'singleConnection': True, 'name': 'outdir', 'cast': True, 'datatype': 'string', 'defaultValue': None, 'required': True, 'height': 8, 'width': 12, 'shape': 'oval', 'color': 'white', 'originalDatatype': 'None'})
...
"""
    InputValidation_42.configure(function=code)
...
try:
    ...
    Output_Directory_Browser_43 = DirBrowserNE(constrkw={}, name='Output Directory Browser', library=stdlib)
    masterNet.addNode(Output_Directory_Browser_43,384,21)
    Output_Directory_Browser_43.inputPortByName['directory'].widget.set(r"AutoDockVSpublic_0.1_output", run=False)
    apply(Output_Directory_Browser_43.configure, (), {'paramPanelImmediate': 1})
except:
    print "WARNING: failed to restore DirBrowserNE named Output Directory Browser in network masterNet"
    print_exc()
    Output_Directory_Browser_43=None

#masterNet.run()
masterNet.freeze()

## saving connections for network AutoDockVSpublic-0.1 ##
...
if Output_Directory_Browser_43 is not None and InputValidation_42 is not None:
    try:
        masterNet.connectNodes(
            Output_Directory_Browser_43, InputValidation_42, "AbsPath_directory", "outdir", blocking=True
            , splitratio=[0.58199058941195325, 0.68236824950005626])
    except:
        print "WARNING: failed to restore connection between Output_Directory_Browser_43 and InputValidation_42 in network masterNet"
