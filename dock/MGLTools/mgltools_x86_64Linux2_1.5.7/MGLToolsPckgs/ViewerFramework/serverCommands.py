...
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/ViewerFramework/serverCommands.py,v 1.19.4.1 2016/02/12 00:29:31 annao Exp $
#
# $Id: serverCommands.py,v 1.19.4.1 2016/02/12 00:29:31 annao Exp $
#
...
if imdFound:
    ...
    #            vt = []
    #            M=[0.,0,0]
    #            #vt=util.ApplyMatrix(numpy.array(self.mol2.allAtoms.coords),M)
