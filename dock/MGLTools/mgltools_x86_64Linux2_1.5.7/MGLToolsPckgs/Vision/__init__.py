...
##################################################################
#
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/Vision/__init__.py,v 1.84.2.2 2015/08/26 18:53:47 sanner Exp $
#
# $Id: __init__.py,v 1.84.2.2 2015/08/26 18:53:47 sanner Exp $
#
...
"""
    ...
    ed.treeNetpane.configurepane('libtree', size=1)
    ed.showLibraries()
    try:
        ed.libraries['Standard'].resizeCategories()
    except KeyError:
        pass
    return ed
...
"""
    ...
    splash =  SplashScreen(about, noSplash=False, app='Vision')
...
NONCRITICAL_DEPENDENCIES = ['magick', 'PIL', 'opengltk', 'DejaVu', 'grail', 'MolKit', 'symserv','Volume', 'Pmv', 'matplotlib', 'pytz', 'AutoDockTools', 'IPython', 'pymedia', 'TkTreectrl']
