# code cited from the paper "Spherical message passing for 3d graph networks" Liu et al.
...
class spherenet(torch.nn.Module):
    def __init__(
            self, energy_and_force=False, data_name='qm9', num_layers=4,
        ...
        self.update_es = torch.nn.ModuleList([
            update_e(hidden_channels, int_emb_size, basis_emb_size, num_spherical, num_radial, num_before_skip,
                     num_after_skip, act) for _ in range(num_layers)])
